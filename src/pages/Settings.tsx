...
export function SettingsPage() {
  ...
  return (
    <div className="w-full bg-background min-h-screen">
      ...
      <div
        className={cn(
          "bg-card fixed inset-y-30 left-90 z-40 w-64 border rounded-3xl transition-transform duration-200 ease-in-out lg:translate-x-0",
                ...
                <button
                  ...
                  className={cn(
                    ...
                    activeSection === item.id
                      ? "dark:bg-secondary bg-primary text-white hover:bg-primary/90"
