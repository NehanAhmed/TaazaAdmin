...
{/*             
        ...
        ```
      */}
            <main className="m-auto h-screen grid min-h-full place-items-center px-6 py-24 sm:py-32 lg:px-8">
                <div className="text-center">
                    ...
                    <div className="mt-10 flex items-center justify-center gap-x-6">
                        ...
                        <a href="#" className="text-sm font-semibold text-secondary hover:text-secondary">
